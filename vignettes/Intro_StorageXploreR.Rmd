...
This can arise adverse situations, such as a lack of storage space or add unnecessary storage costs.
...
* Full file name: concatenation of the name and extension with a dot in between.  
...
The parsers assume that the files follow the naming convention: \<NAME\>.\<EXTENSION\>.
...
multicopy_idx = detect_multicopy_files(full_names, dataset[,1])
```
